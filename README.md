# facebookresearch-repos

`facebookresearch-repos` is a static catalog of active repositories from Meta
Research's `facebookresearch` GitHub organization. It groups public research
repositories by purpose and keeps GitHub metadata fresh with a scheduled
update script.
...
The six clusters cover vision/video/3D, language/speech/multimodal, agents and
reinforcement learning, embodied AI/AR/robotics, ML systems and optimization,
and data/evaluation/science.
...
- `favicon.svg` - Facebook Research-themed favicon.
...
- `cloudflare/worker.js` - proxies the site at `https://glaubi.net/facebookresearch`.
