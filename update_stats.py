#!/usr/bin/env python3
"""
Build and refresh the Facebook Research GitHub repository catalog.

The script fetches public GitHub metadata for Meta Research repositories in the
facebookresearch organization that were updated in the last three months and
have more than 200 stars, groups them into research clusters, and rewrites
index.html.
...
USER_AGENT = "facebookresearch-repos-catalog"
AUTO_KEYWORD_TERMS: tuple[tuple[str, tuple[str, ...]], ...] = (
    ("Computer Vision", ("computer vision", "visual recognition", "image segmentation")),
    ("3D", ("3d", "three-dimensional", "geometry", "reconstruction")),
    ("Video", ("video", "tracking", "temporal")),
    ("AR", ("augmented reality", "project aria", "wearable")),
    ("Speech", ("speech", "asr", "voice")),
    ("Audio", ("audio", "music", "codec")),
    ("NLP", ("natural language", "nlp", "language model")),
    ("Translation", ("translation", "multilingual")),
    ("Multimodal", ("multimodal", "vision-language", "vision language")),
    ("Agents", ("agent", "agents", "agentic")),
    ("Reinforcement Learning", ("reinforcement learning", "contextual bandit")),
    ("Robotics", ("robot", "robotics", "embodied ai")),
...
CLUSTERS: tuple[Cluster, ...] = (
    Cluster(
        "vision-video-3d",
        "Vision, Video & 3D",
        "Segmentation, recognition, tracking, visual geometry, 3D reconstruction, and generative vision research.",
        "blue",
        (
            "3d",
            "camera",
    ...
    Cluster(
        ...
        "Language, Speech & Multimodal",
        "Language models, translation, speech, audio, multimodal representation learning, and generation.",
        "purple",
        (
            "audio",
            "language",
    ...
    Cluster(
        ...
        "Agent environments, reasoning systems, reinforcement learning, contextual bandits, and planning.",
        "cyan",
        (
            "agent",
            "bandit",
    ...
    Cluster(
        "embodied-ar-robotics",
        "Embodied AI, AR & Robotics",
        "Embodied agents, robotics, simulation, egocentric perception, wearables, animation, and Project Aria.",
        "green",
        (
            "animation",
            "aria",
    ...
    Cluster(
        ...
        "ML Systems, Optimization & Core Libraries",
        "Reusable ML libraries, vector search, configuration, performance, optimization, and training infrastructure.",
        "yellow",
        (
            "configuration",
            "distributed",
    ...
    Cluster(
        ...
        "Data, Evaluation & Science",
        "Datasets, benchmarks, measurement, time series, chemistry, neuroscience, privacy, and scientific applications.",
        "red",
        (
            "benchmark",
            "chemistry",
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Update Facebook Research GitHub repository catalog.")
...
def cluster_repo(repo: dict[str, Any]) -> Cluster:
    ...
    name_overrides = {
        ...
        "eyefultower": "data-evaluation-science",
        ...
        "mmf": "language-speech-multimodal",
        "multimodal": "language-speech-multimodal",
        "nevergrad": "ml-systems-optimization",
        "pearl": "agents-reasoning-rl",
        "programbench": "data-evaluation-science",
        "project_superdex": "embodied-ar-robotics",
        "pytorch3d": "vision-video-3d",
        "reagent": "agents-reasoning-rl",
        "sam2": "vision-video-3d",
        "sam3": "vision-video-3d",
        "schedule_free": "ml-systems-optimization",
...
<title>Facebook Research GitHub Repository Atlas</title>
...
<style>
  ...
  * {{ box-sizing: border-box; }}
  ...
  .jump-nav a:hover {{
    border-color: var(--facebookresearch);
    color: var(--facebookresearch);
  ...
  .section-mark {{
    ...
    height: 20px;
    border-radius: 2px;
    background: var(--facebookresearch);
  ...
  .activity-bar span {{
    ...
    background: linear-gradient(90deg, var(--facebookresearch), var(--green), var(--yellow));
  }}
  ...
  .footer a {{ color: var(--facebookresearch); text-decoration: none; }}
...
<body>
  <header class="header page-header">
    <h1 class="page-title"><span class="logo-box">FR</span>Facebook Research GitHub Repository Atlas</h1>
    <p>Searchable snapshot of public repositories from Meta Research's <a href="https://github.com/orgs/facebookresearch/repositories" target="_blank" rel="noreferrer">facebookresearch organization</a>. Included repositories have more than 200 stars and were pushed within the last three months, since {cutoff}.</p>
    <div class="metric-strip" aria-label="Catalog summary">
      ...
      <div class="metric-card"><strong>{len(CLUSTERS)}</strong><span>research clusters</span></div>
    </div>
...
{extra_section_html}
  ...
  <footer class="footer">
    <p style="margin-bottom: 10px;">Useful links:
      <a class="gh-link" href="https://ai.meta.com/research/" target="_blank" rel="noreferrer" style="display: inline; margin-left: 6px;">Meta AI Research</a>
      <span style="margin: 0 4px;">·</span>
      <a class="gh-link" href="https://research.facebook.com/publications/" target="_blank" rel="noreferrer" style="display: inline;">Publications</a>
      <span style="margin: 0 4px;">·</span>
      <a class="gh-link" href="https://opensource.fb.com/" target="_blank" rel="noreferrer" style="display: inline;">Meta Open Source</a>
    </p>
...
def main() -> int:
    ...
    print(f"Wrote {args.file} with {len(repos)} Facebook Research repositories")
